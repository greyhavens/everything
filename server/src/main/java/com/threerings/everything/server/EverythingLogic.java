...
public class EverythingLogic
{
        ...
        throws ServiceException
    {
        ...
        if (player == null) {
            ...
            String seed = CookieUtil.getCookieValue(req, AuthServlet.SEED_COOKIE);
...
//             }
    ...
    public List<FeedItem> getUserFeed (PlayerRecord caller, int userId) throws ServiceException
    {
        ...
        if (target == null) {
            throw new ServiceException(EverythingService.E_UNKNOWN_USER);
        }
    ...
    public List<PlayerStats> getFriends (PlayerRecord player) throws ServiceException
    {
    ...
    public EverythingService.CreditsResult getCredits () throws ServiceException
    {
        EverythingService.CreditsResult result = new EverythingService.CreditsResult();
