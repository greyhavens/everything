 ...
 */
public interface BlingImages extends ClientBundle
{
    ...
    @Source("fbcredit.png")
    ImageResource fbcredit ();

    @Source("buywithfb_up.png")
    ImageResource buywithfb_up ();

    @Source("buywithfb_down.png")
    ImageResource buywithfb_down ();
}
